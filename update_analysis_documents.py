#!/usr/bin/env python3
"""
Update all analysis documents with new benchmark results.
"""
...
def update_three_platform_comparison(data):
    """Update THREE_PLATFORM_COMPARISON.md with new results."""

    content = f"""# Three-Platform Document Storage Comparison
...
"""
    ...
    with open('THREE_PLATFORM_COMPARISON.md', 'w') as f:
        f.write(content)

    print("✓ Updated THREE_PLATFORM_COMPARISON.md")

def main():
    """Main execution."""
    print("Updating analysis documents with new benchmark results...\n")

    data = load_results()
    update_three_platform_comparison(data)

    print("\n✓ All documents updated with exact benchmark results")
